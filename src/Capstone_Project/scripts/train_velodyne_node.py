...
class td3(object):
    def __init__(self, state_dim, action_dim, max_action):
        ...
        self.writer = SummaryWriter(log_dir="./src/Capstone_Project/runs/train/tensorboard")
            ...
            if timestep < max_timesteps:
                ...
                if done:
                    ...
                    if timesteps_since_eval >= eval_freq:
                        ...
                        network.save(file_name, directory="./src/Capstone_Project/runs/train/pytorch_models")
                        np.save("./src/Capstone_Project/runs/train/results/%s" % (file_name), evaluations)
                        epoch += 1
