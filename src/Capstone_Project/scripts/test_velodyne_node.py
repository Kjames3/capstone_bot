...
if __name__ == '__main__':
    ...
    try:
        # network.load(file_name, "./src/Capstone_Project/runs/test/pytorch_models")
        network.load(file_name, "/home/kam/capstone_ws/src/DRL_Navigation_Robot_ROS2_Foxy/src/Capstone_Project/runs/test/pytorch_models")
    except:
        raise ValueError("Could not load the stored model parameters")
    
    writer = SummaryWriter(log_dir="./src/Capstone_Project/runs/test/tensorboard")
